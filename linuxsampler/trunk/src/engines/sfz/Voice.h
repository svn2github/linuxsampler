...
namespace LinuxSampler { namespace sfz {
     ...
     */
    class Voice : public LinuxSampler::VoiceBaseImpl< ::sfz::Region, SampleFile> {
        public:
            ...
            int  Trigger(EngineChannel* pEngineChannel, Pool<Event>::Iterator& itNoteOnEvent, int PitchBend, ::sfz::Region* pRegion, type_t VoiceType, int iKeyGroup);
        ...
        //private:
            ...
            SampleFile*                 pSample;            ///< Pointer to the sample to be played back
